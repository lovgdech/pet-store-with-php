<div class="p-4 mx-auto w-100" style="max-width: 1000px;">
    ...
    <form class="my-4 w-100" action="index.php?controller=products&action=edit_product_submit" method="POST">
        <div class="mb-3 mt-3">
        ...
        <div class="mb-3 mt-3 d-flex gap-2" style="gap: 50px;">
            <div style="flex: 1;">
                ...
                <input type="text" class="form-control" id="productId" value="<?php echo $product->productId ?>"
        ...
        <div class="mb-3 d-flex gap-2" style="gap: 50px;">
            ...
            <div class="flex-item flex-grow-1">
                ...
                <input type="number" class="form-control" id="quanlity" value="<?php echo $product->quanlity ?>"
                    name="quanlity" required>
            </div>
        </div>
        <div class="mb-3 mt-3">
        ...
        <div class="form-check mb-3">
            <label class="form-check-label">
                <input class="form-check-input" type="checkbox" value="1" name="enable"
                    <?php if ($product->enable == 1) echo 'checked'; ?>> Kích hoạt
            </label>
        </div>
